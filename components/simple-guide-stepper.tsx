          ...
          <div className="flex flex-col p-4 gap-4 border border-muted rounded-lg transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-foreground/10">
            ...
            <p className="text-lg text-muted-foreground">
              ...
              <Image
                ...
                className="inline mb-2"
              />{" "}{poolData?.quoteAsset}{" "}
              0.3% pool. You can choose an appropriate liquidity range and token amounts based on your risk tolerance and preferences. <span className="bg-yellow-500 text-black p-1">Please note that only active liquidity within the current price range is eligible to participate in farming. Unilateral liquidity that is temporarily inactive will likely not receive any incentives during the event period.</span>
            </p>
            <Button asChild className="w-fit self-end">
